...
FORM_SHIP_TYPE: str = "ship_type"
FORM_SHIP_DIRECTION: str = "ship_direction"
FORM_COORDINATE_ROW: str = "ship_coordinate_row"
FORM_COORDINATE_COLUMN: str = "ship_coordinate_col"
FORM_FIELD: str = "player_field"
